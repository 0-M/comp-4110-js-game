...
int main(int argc, char * argv[]) {
    ...
    printf("   mantissa: 0x%x or: ", float_32.f_bits.mantissa);
    for(i = 0; i < 40; i++) {
        if(i > 10) {
    ...
    printf("\n       sign: %d        or: %d",float_32.bit.b31,float_32.bit.b31);
    printf("\n in base 10: %g   or: %s",float_32.floating_value_in_32_bits,bit_string);
