...
private:
  sf::Image image_;       //< Will hold the address for where the image is
...
class Universe : public sf::Drawable {
 public:
    ...
    Universe(double total_time, double change_time, std::string file_name,double win_x, double win_y);
