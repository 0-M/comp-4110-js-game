...
int main(int argc, char* argv[]) {
    ...
    sf::Color p; ///< color that will be changed and assigned each time in the loop
    ...
    sf::RenderWindow window1(sf::VideoMode(size.x, size.y), "Original"); ///< Window for original image

    sf::RenderWindow window2(sf::VideoMode(size.x, size.y), "Encrypted"); ///< Window for encrypted image
    ...
    while (window1.isOpen() && window2.isOpen()) { ///< Opening and closing the windows
