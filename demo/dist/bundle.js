...
var _Level = __webpack_require__(/*! ./states/levels/Level1 */ 315);
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, game, tileX * game.tileWidth, tileY * game.tileWidth, asset));

    _this.anchor.setTo(0.5);
    game.physics.enable(_this, _phaser2.default.Physics.ARCADE);
    _this.body.onCollide = new _phaser2.default.Signal();
    _this.body.onCollide.add(_this.collected, _this);
    return _this;
  }
...
var _class = function (_Phaser$Sprite) {
  ...
  function _class(_ref) {
    ...
    _this.tileX = tileX;
    _this.tileY = tileY;
    _this.x = tileX * game.tileWidth;
    _this.y = tileY * game.tileWidth;
    game.physics.enable(_this, _phaser2.default.Physics.ARCADE);
    game.camera.follow(_this);
    return _this;
  }
...
var _Pizza = __webpack_require__(/*! ../sprites/Pizza */ 122);
...
module.exports = __webpack_require__(/*! /Users/mmarkman/comp-4110-js-game/prototype/src/main.js */119);
...
var _health = __webpack_require__(/*! ../../ui/health */ 316);

var _levelXP = __webpack_require__(/*! ../../ui/levelXP */ 317);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'preload',
    value: function preload() {
      this.load.tilemap('level1map', 'assets/maps/prototype_entry.json', null, _phaser2.default.Tilemap.TILED_JSON);
      this.load.image('pizza', 'assets/images/pizza-1.png');
    ...
    value: function create() {
      this.tileWidth = 48;
      this.setupTileMap();
      _health.health.addHealthToLevel(this);
      _levelXP.levelXP.addXPToLevel(this);
      this.physics.startSystem(_phaser2.default.Physics.ARCADE);
    }
  }, {
    key: 'setupTileMap',
    value: function setupTileMap() {
      ...
      var map = this.game.add.tilemap('level1map');
      ...
      var exit = this.map.objects.metadata.find(function (o) {
        return o.name === 'exit';
      });
      this.exitRect = new _phaser2.default.Rectangle(exit.x, exit.y, exit.width, exit.height);
    }
  }, {
    key: 'initPlayer',
    ...
    value: function render() {
      ...
      if (_phaser2.default.Rectangle.containsPoint(this.exitRect, this.player.position)) {
        this.resetPlayer();
      }
    }
  }, {
...
var Health = function () {
  ...
  _createClass(Health, [{
    key: 'addHealthToLevel',
    value: function addHealthToLevel(game) {
      ...
      this.text.setTextBounds(_config2.default.padding, _config2.default.padding, game.width - _config2.default.padding, game.height - _config2.default.padding);
    }
  }]);
...
var health = exports.health = new Health(); // singleton
...
var LevelXP = function () {
  function LevelXP() {
    _classCallCheck(this, LevelXP);
  ...
  _createClass(LevelXP, [{
    key: 'addXPToLevel',
    value: function addXPToLevel(game) {
      var style = { font: '16px Arial',
        fill: '#fff',
        align: 'center', // the alignment of the text is independent of the bounds, try changing to 'center' or 'right'
        boundsAlignH: 'right',
...
var levelXP = exports.levelXP = new LevelXP(); // singleton
